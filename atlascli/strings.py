...
STRINGS: dict[str, dict[str, str]] = {
    ...
    "opt.no_projects": {"it": "aggiorna solo l'eseguibile, non i progetti registrati",
                       "en": "update only the executable, not the registered projects"},
    ...
    "help.update": {"it": "aggiorna atlas e riallinea i progetti registrati",
                   "en": "updates atlas and realigns the registered projects"},
    ...
    "install.dashboard_rifatte": {"it": "dashboard rigenerate: {n}", "en": "dashboards refreshed: {n}"},
    "install.dashboard_errore": {"it": "dashboard non rigenerate ({errore}): riprova con atlas render --all",
                                "en": "dashboards not refreshed ({errore}): retry with atlas render --all"},
