...
STRINGS: dict[str, dict[str, str]] = {
    ...
    "render.legenda_caption": {"it": "passa il puntatore su un nodo per leggerne la domanda, "
                                     "cliccalo per aprirne il ticket",
                              "en": "hover a node to read its question, click it to open its ticket"},
