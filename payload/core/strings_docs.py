...
STRINGS: dict[str, dict[str, str]] = {
    ...
    "render.pannello_nodo": {"it": "nodo", "en": "node"},
    "render.pannello_selettore": {"it": "vista del pannello", "en": "panel view"},
    ...
    "render.zoom_lock": {"it": "blocca l'interazione col grafo", "en": "lock interaction with the graph"},
    "render.zoom_unlock": {"it": "sblocca l'interazione col grafo", "en": "unlock interaction with the graph"},
    "render.layout_reset": {"it": "riporta le card al layout calcolato",
                            "en": "reset the cards to the computed layout"},
