...
STRINGS: dict[str, dict[str, str]] = {
    ...
    "mutate.link_lista_non_valida": {"it": "{id} ha 'links' che non è una lista",
                                     "en": "{id} has a 'links' field that isn't a list"},
    "mutate.link_invalido": {"it": "{id} ha un link malformato: serve un oggetto con label ed url",
                             "en": "{id} has a malformed link: an object with label and url is required"},
    "mutate.link_url_non_valido": {"it": "{id}: l'URL «{url}» non è valido, serve uno schema http o https",
                                   "en": "{id}: the URL «{url}» is not valid, an http or https scheme is required"},
