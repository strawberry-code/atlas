...
STRINGS: dict[str, dict[str, str]] = {
    ...
    "howto.primi_passi": {"it": "    1. atlas status              la frontiera: cosa è prendibile adesso\n"
                                ...
                                "    3. lavora, registrando ogni attività con atlas log <ID> \"cosa hai fatto\"\n"
                                "       (una voce chi · quando / cosa nella Lavorazione del ticket), poi scrivi la Risposta\n"
                                "    4. atlas close <ID> -s \"la sintesi in una riga\"\n"
                                "       oppure, se ti fermi a metà: atlas suspend <ID> -m \"dove sei arrivato\"\n"
                                ...
                                "  close rifiuta un ticket senza voci in Lavorazione o senza Risposta; suspend pretende le voci.\n"
                          ...
                          "en": "    1. atlas status              the frontier: what's takeable right now\n"
                                ...
                                "    3. work it, recording every activity with atlas log <ID> \"what you did\"\n"
                                "       (an entry who · when / what in the ticket's Work section), then write the Answer\n"
                                "    4. atlas close <ID> -s \"the one-line summary\"\n"
                                "       or, if you stop halfway: atlas suspend <ID> -m \"where you got to\"\n"
                                ...
                                "  close refuses a ticket with no Work entries or no Answer; suspend requires the entries.\n"
