...
Se vuoi lasciare un ordine di grandezza di quanto è costato (chiamate, token, tempo), aggiungi `-c/--costo "..."`; per indicare esplicitamente i file prodotti, `--artefatti path/uno path/due`. Nel ticket, le sotto-sezioni **Scelte non canoniche**, **Debito dichiarato** e **Autorizzazioni ricevute** sotto Risposta sono facoltative: usale quando c'è davvero qualcosa da dire, altrimenti lasciale vuote.
